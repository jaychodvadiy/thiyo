                  ...
                  <div className="d-none d-lg-block">
                    <div className="selectsheet">
                      <div className="card mb-2">
                        <div>
                          <div className="form-check form-switch">
                            <label for="flexSwitchCheckChecked cursor-pointer">
                              <p className="selectcircle">
                                Verified Properties
                              </p>
                            </label>
                            <input
                              className="form-check-input float-end cursor-pointer"
                              role="switch"
                        ...
                        <div className="verifed d-flex gap-2 align-items-center">
                            ...
                            >
                              <div className="accordion-body">
                                ...
                                >
                                  ...
                                  >
                                    <div className="d-flex flex-wrap gap-2">
                                      <button className="false">Office</button>
                                      <button className="false">
                                        Warehouse
                                      </button>
                        ...
                        <div className="popularmain">
                          <div className="popularicon">
                            <svg
                              ...
                              xmlns="http://www.w3.org/2000/svg"
                            >
                              <g clip-path="url(#clip0_8952_3030)">
                                <path
                          ...
                          >
                            ...
                            >
                              <svg
                                ...
                                xmlns="http://www.w3.org/2000/svg"
                              >
                                <g clip-path="url(#clip0_8952_3033)">
                                  <path
                                ...
                                <div className="swiper swiper-creative swiper-3d swiper-initialized swiper-horizontal swiper-watch-progress mySwiper6">
                                  ...
                                  >
                                    <div
                                      ...
                                      style="width: 300px; z-index: 6; transform: translate3d(calc(0px), calc(0px), calc(0px)) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scale(1); opacity: 1;"
                                    >
                                      <div className="productslider h-100 position-relative">
                                        {/* <img src="https://storage.googleapis.com/download/storage/v1/b/thiyo-api.appspot.com/o/images%2Fa9f3c2d4-4510-4c36-9dc5-94e212578067_d8ea57605add41a787f23448281fb2c9.jpg?generation=1699521961424802&amp;alt=media" alt="Image" className="w-100 h-100"> */}
                                        {/*  */}
                                      </div>
                                    </div>
                                    <div
                                      className="swiper-slide swiper-slide-next"
                                      style="width: 300px; z-index: 5; transform: translate3d(calc(5% - 300px), calc(0px), calc(-200px)) rotateX(0deg) rotateY(-100deg) rotateZ(0deg) scale(1); opacity: 1; transform-origin: right center;"
                                    >
                                      <div className="productslider h-100 position-relative">
                                        {/* <img src="https://storage.googleapis.com/download/storage/v1/b/thiyo-api.appspot.com/o/images%2Fe2923294-e4db-4729-aa36-06429f682f37_dubai-real-estate-market.jpg?generation=1699521961681697&amp;alt=media" alt="Image" className="w-100 h-100"> */}
                                        {/*  */}
                                      </div>
                                    </div>
                                    <div
                                      className="swiper-slide"
                                      style="width: 300px; z-index: 4; transform: translate3d(calc(5% - 600px), calc(0px), calc(-200px)) rotateX(0deg) rotateY(-100deg) rotateZ(0deg) scale(1); opacity: 1; transform-origin: right center;"
                                    >
                                      <div className="productslider h-100 position-relative">
                                        {/* <img src="https://storage.googleapis.com/download/storage/v1/b/thiyo-api.appspot.com/o/images%2F87c974a5-beff-42df-a71e-0c363402a150_DvV3HbwjUW_MPp2.webp?generation=1699521961945605&amp;alt=media" alt="Image" className="w-100 h-100"> */}
                                        {/*  */}
                                      </div>
                                    </div>
                                    <div
                                      className="swiper-slide"
                                      style="width: 300px; z-index: 3; transform: translate3d(calc(5% - 900px), calc(0px), calc(-200px)) rotateX(0deg) rotateY(-100deg) rotateZ(0deg) scale(1); opacity: 1; transform-origin: right center;"
                                    >
                                      <div className="productslider h-100 position-relative">
                                        {/* <img src="https://storage.googleapis.com/download/storage/v1/b/thiyo-api.appspot.com/o/images%2F69a81e9e-9b8b-4b74-b3ee-b6a072ab64b6_ezgif-3-90c1541757e4%20(1)_1586497826.jpg?generation=1699521962195520&amp;alt=media" alt="Image" className="w-100 h-100"> */}
                                        {/*  */}
                                      </div>
                                    </div>
                                    <div
                                      className="swiper-slide"
                                      style="width: 300px; z-index: 2; transform: translate3d(calc(5% - 1200px), calc(0px), calc(-200px)) rotateX(0deg) rotateY(-100deg) rotateZ(0deg) scale(1); opacity: 1; transform-origin: right center;"
                                    >
                                      <div className="productslider h-100 position-relative">
                                        {/* <img src="https://storage.googleapis.com/download/storage/v1/b/thiyo-api.appspot.com/o/images%2F01defca6-513c-48b8-9b7b-ce90905a067f_home-2409004_640.jpg?generation=1699521962442219&amp;alt=media" alt="Image" className="w-100 h-100"> */}
                                        {/*  */}
                                      </div>
                                    </div>
                                    <div
                                      className="swiper-slide"
                                      style="width: 300px; z-index: 1; transform: translate3d(calc(5% - 1500px), calc(0px), calc(-200px)) rotateX(0deg) rotateY(-100deg) rotateZ(0deg) scale(1); opacity: 1; transform-origin: right center;"
                                    >
                                      <div className="productslider h-100 position-relative">
                                        {/* <img src="https://storage.googleapis.com/download/storage/v1/b/thiyo-api.appspot.com/o/images%2F5da23bb1-ac47-4aaa-bf7f-df7e76cc65e9_house-2483336_640.jpg?generation=1699521962724109&amp;alt=media" alt="Image" className="w-100 h-100"> */}
                                        {/*  */}
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div className="d-flex align-items-start justify-content-start flex-column">
                                    <div>
                                      ...
                                      <div className="mb-3 d-flex gap-3 align-items-center flex-wrap">
                                        ...
                                        <div className="bathdetailitems">
                                          {/* <img src="/_next/static/media/parking.86354047.png" alt=""> */}
                                ...
                                <div className="position-relative h-100">
                                  <div className="swiper swiper-creative swiper-3d swiper-initialized swiper-horizontal swiper-watch-progress mySwiper6">
                                    ...
                                    >
                                      ...
                                      >
                                        <div className="productslider h-100 position-relative">
                                          {/* <img src="https://storage.googleapis.com/download/storage/v1/b/thiyo-api.appspot.com/o/images%2Ff4b6fc7c-7942-4c00-a874-a9038bb2477d_1_s8mRrJ2oItQDmHjshm9s7Q.jpg?generation=1699521960449732&amp;alt=media" alt="Image" className="w-100 h-100"> */}
                                          {/*  */}
                                        </div>
                                      </div>
                                      <div
                                      ...
                                      >
                                        <div className="productslider h-100 position-relative">
                                          {/* <img src="https://storage.googleapis.com/download/storage/v1/b/thiyo-api.appspot.com/o/images%2Fda458979-4725-49e8-bba3-7e126946896e_66b750dae8ff47f68c89098b450ae7e8-cc_ft_960.jpg?generation=1699521960889115&amp;alt=media" alt="Image" className="w-100 h-100"> */}
                                          {/*  */}
                                        </div>
                                      </div>
                                      <div
                                      ...
                                      >
                                        <div className="productslider h-100 position-relative">
                                          {/* <img src="https://storage.googleapis.com/download/storage/v1/b/thiyo-api.appspot.com/o/images%2F44eeaaeb-b2ce-437c-9733-e9c368b17b20_823189319.jpg?generation=1699521961161097&amp;alt=media" alt="Image" className="w-100 h-100"> */}
                                          {/*  */}
                                        </div>
                                      </div>
                                      <div
                                    ...
                                    <div className="d-flex align-items-start justify-content-start flex-column">
                                      <div>
                                        ...
                                        <h4 className="cursor-pointer prod-title">
                                          ...
                                          the printing and typesetting indus...
                                        </h4>
                                        <p className="downtown prod-location">
                                          <svg
                                            width="15"
                          ...
                          <div className="mb-3">
                                ...
                                <div className="position-relative h-100">
                                  <div className="swiper swiper-creative swiper-3d swiper-initialized swiper-horizontal swiper-watch-progress mySwiper6">
                                    ...
                                    >
                                      ...
                                      >
                                        <div className="productslider h-100 position-relative">
                                          {/* <img src="https://storage.googleapis.com/download/storage/v1/b/thiyo-api.appspot.com/o/images%2Ff4b6fc7c-7942-4c00-a874-a9038bb2477d_1_s8mRrJ2oItQDmHjshm9s7Q.jpg?generation=1699521960449732&amp;alt=media" 
                                      alt="Image" className="w-100 h-100"></div> */}
                                        </div>
                                        <div
                                          className="swiper-slide swiper-slide-next"
                                          style="width: 300px; z-index: 5; transform: translate3d(calc(5% - 300px), calc(0px), calc(-200px)) rotateX(0deg) rotateY(-100deg) rotateZ(0deg) scale(1); opacity: 1; transform-origin: right center;"
                                        >
                                          <div className="productslider h-100 position-relative">
                                            {/* <img src="https://storage.googleapis.com/download/storage/v1/b/thiyo-api.appspot.com/o/images%2Fda458979-4725-49e8-bba3-7e126946896e_66b750dae8ff47f68c89098b450ae7e8-cc_ft_960.jpg?generation=1699521960889115&amp;alt=media" 
                                      alt="Image" className="w-100 h-100"></div> */}
                                          </div>
                                          <div
                                            className="swiper-slide"
                                ...
                                <div className="col-12 col-sm-6 col-xl-4 col-xxxl-3 mb-3">
                                  <div className="card cstm-card-main cstm-card-main-cs">
                                    <div className="position-relative">
                                      {/* <img src="https://storage.googleapis.com/download/storage/v1/b/thiyo-api.appspot.com/o/images%2Fa9f3c2d4-4510-4c36-9dc5-94e212578067_d8ea57605add41a787f23448281fb2c9.jpg?generation=1699521961424802&amp;alt=media" alt="img" className="img-fluid pro-img w-100">
                           <div className=" gallery"> */}
                                      ...
                                      <div className="w-50 d-flex align-items-center gap-2 justify-content-end">
                                        <div className="cursor-pointer">
                                          <svg
                                            ...
                                            xmlns="http://www.w3.org/2000/svg"
                                          >
                                            <g clip-path="url(#clip0_8952_3529)">
                                              <path
                              ...
                              <div className="col-12 col-sm-6 col-xl-4 col-xxxl-3 mb-3">
                                <div className="card cstm-card-main cstm-card-main-cs">
                                  <div className="position-relative">
                                    {/* <img src="https://storage.googleapis.com/download/storage/v1/b/thiyo-api.appspot.com/o/images%2Ff4b6fc7c-7942-4c00-a874-a9038bb2477d_1_s8mRrJ2oItQDmHjshm9s7Q.jpg?generation=1699521960449732&amp;alt=media" alt="img" className="img-fluid pro-img w-100">
                           <div className=" gallery"> */}
                                    <svg
                                      width="13"
                                      height="13"
