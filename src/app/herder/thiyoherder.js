      ...
      <nav className="navbar navbar-expand-lg">
        <div className="container">
          ...
          <div className="d-flex align-items-center">
            <div className="listproperty block d-lg-none relative">
              <button className="button flex align-items-center justify-content-center gradient-hover-effect">
                List Property free
                <div className="listnew flex align-items-center justify-content-center absolute"></div>
              </button>
            </div>
            <button
              className="navbar-toggler"
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ms-auto mx-lg-auto mb-2 mb-lg-0 align-items-start">
              <li className="nav-item border-0 dropdown Real_Estate">
                <a
                  className="nav-link  gap-2  d-flex align-items-center"
                  role="button"
            ...
            <div class="d-flex">
              <form class="d-flex align-items-center" role="search">
                <div class="dropdown d-none d-lg-block">
                  <div
                    class="useractive button p-0 d-flex gap-2"
                    id="dropdownMenuButton1"
                    aria-expanded="false"
                  >
                    <svg
                  ...
                  <ul
                    class="dropdown-menu userlist"
                    aria-labelledby="dropdownMenuButton1"
                  >
                    <li>
                      <a class="dropdown-item mb-3 py-0 viewprofile" href="#">
                        You are viewing your personal profile
                      </a>
                    </li>
                    <li>
                      <div class="d-flex myprofile px-3">
                        <div>
                          <svg
                            width="25"
                            height="25"
                        ...
                        <div class="">
                          <a class="mb-2 fw-semibold" href="/dashboard">
                            My Profile
                          </a>
                          <p>
                    ...
                    <li>
                      <div class="d-flex myprofile px-3">
                        ...
                        <div class="">
                          <h3 class="mb-2 cursor-pointer">My Trips</h3>
                          <p>
                            See booking details, Print e-ticket, Cancel Booking,
                            Modify Booking, Check Refund Status &amp; more.
                          </p>
                        </div>
                      </div>
                    </li>
                    <li>
                      <div class="d-flex myprofile px-3">
                        ...
                        <div class="">
                          <h3 class="mb-2 cursor-pointer">My Wallet</h3>
                          <p>
                            See booking details, Print e-ticket, Cancel Booking,
                            Modify Booking, Check Refund Status &amp; more.
                          </p>
                    ...
                    <li>
                      <div class="d-flex myprofile px-3">
                        ...
                        <div class="">
                          <h3 class="mb-2 cursor-pointer">Make a payment</h3>
                    ...
                    <li>
                      <div class="d-flex myprofile px-3">
                        ...
                        <div class="">
                          <h3 class="mb-2 cursor-pointer">Manage Alerts</h3>
                        </div>
                      </div>
                    </li>
                    <li>
                      <div class="d-flex myprofile px-3">
                        ...
                        <div class="">
                          <h3 class="mb-2 cursor-pointer">My Reviews</h3>
                        </div>
                      </div>
                    </li>
                    <li>
                      <div class="d-flex myprofile px-3 cursor-pointer">
                        <div>
                          <svg
                            width="25"
                            height="25"
