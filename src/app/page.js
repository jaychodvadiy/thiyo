                    ...
                    <div className="countryfeaturehome">
                      <div className="card cstm-card-main">
                        ...
                        <div className="card-body cstm-card-body-main">
                          <p className="title">The Most Luxurious House</p>
                          ...
                          <div className="btn-main">
                            <p className="outlines">AED 45,000</p>
                            <Link href="/listpage">
                      ...
                      <div className="card cstm-card-main">
                        ...
                        <div className="card-body cstm-card-body-main">
                          <p className="title">Flint Hill Luxurious House</p>
                          <div className="d-flex pb-2 pb-lg-0 my-1 my-lg-2 gap-1 align-items-center">
                            <svg
                              width="20"
                              height="20"
                          ...
                          <div className="btn-main">
                            <p className="outlines">AED 65000</p>
                            <Link href="/listpage">
                              <button type="button" className="outline">
                                View Details
                              </button>
                      ...
                      <div className="card cstm-card-main">
                        ...
                        <div className="card-body cstm-card-body-main">
                          <p className="title">The Sky View Farm House</p>
                          <div className="d-flex pb-2 pb-lg-0 my-1 my-lg-2 gap-1 align-items-center">
                            <svg
                              width="20"
                              height="20"
                          ...
                          <div className="btn-main">
                            <p className="outlines">AED 58000</p>
                            <Link href="/listpage">
                              <button type="button" className="outline">
                                View Details
                              </button>
                      ...
                      <div className="card cstm-card-main">
                        ...
                        <div className="card-body cstm-card-body-main">
                          <p className="title">
                          Super Townhouse Oak A2 Indiranagar 2nd Stage  
                          </p>
                          <div className="d-flex pb-2 pb-lg-0 my-1 my-lg-2 gap-1 align-items-center">
                            <svg
                              width="20"
                            ...
                            <p className="card-title ">
                            137, 1st B cross Road, Domlur 2nd stage, Indiranagar, Bangalore, India, Bangalore                            </p>
                          </div>
                          <div className="d-flex justify-content-between gap-2 flex-wrap house-main house-main-02 align-items-center">
                            <a href="#">
                              <span className="">
                          ...
                          <div className="btn-main">
                            <p className="outlines">AED 69  000</p>
                            <Link href="/listpage">
                              <button type="button" className="outline">
                                View Details
                              </button>
